...
- Distill accepts an unchanged session with a `saved 0, updated <digits>` no-op report.

## [0.28.2] - 2026-09-23

### Fixed

- Distill no longer fails with "database is locked" when another process writes at session end.
